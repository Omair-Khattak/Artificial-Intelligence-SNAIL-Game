...
class Game(arcade.View):
    ...
    def on_draw(self):
        ...
        if self.state == "GameMenu":
            ...
            arcade.draw_text(" BOT Score = " + str(self.BOTScore), 690, 400, font_size=18)
            arcade.draw_lrwh_rectangle_textured(600,180, 400, 300, vs)
            arcade.draw_text(" Omair Khattak " , 690, 240,font_size=18)
            arcade.draw_text(" Tariq Shehzad ", 690, 200,font_size=18)
            arcade.draw_text(" Kiran Zafar " , 690, 160,font_size=18)
            arcade.draw_text(" Fareeha Bano " , 690, 120,font_size=18)
            Y = boxSize
            temp = 0
            #print(self.board)
            ...
            if self.win == "human1":
                ...
                arcade.draw_text("Congratulation BOT has Won :)", 100, 300, arcade.color.WHITE, font_size=35)
